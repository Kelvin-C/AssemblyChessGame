...
y1 = np.linspace(0, 0.11, 3) 
x1 = np.array([0.051]*len(y1))
y1 = y1[::-1]

x2 = np.linspace(0, 0.051, 2) 
y2 = np.linspace(0.,0.051/2., 2)
x2 = x2[::-1]

x3 = np.linspace(0, 0.051, 2) 
y3 = np.linspace(0.051/2.,0.051, 2)

x4 = np.linspace(0, 0.051, 2) 
y4 = np.linspace(0.051,0.051*1.5, 2)
x4 = x4[::-1]

x5 = np.linspace(0, 0.051, 2) 
y5 = np.linspace(0.051*1.5,0.11, 2)
