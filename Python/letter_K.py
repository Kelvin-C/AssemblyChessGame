...
y1 = np.linspace(0, 0.051, 2) 
x1 = np.array([0.051]*len(y1))
#x1 = np.zeros(len(y1))


x2 = np.linspace(0, 0.051, 3) 
y2 = np.linspace(0.05, 0.11, 3)
x2 = x2[::-1]

x4 = x2[::-1]
y4 = y2[::-1]

x3 = np.linspace(0, 0.051, 3) 
...
y6 = np.linspace(0.051, 0.11, 2) 
x6 = np.array([0.051]*len(y1))
...
x_lst = [x1,x2,x4,x3,x5,x6]
y_lst = [y1,y2,y4,y3,y5,y6]
